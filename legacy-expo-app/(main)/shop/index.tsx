...
const styles = StyleSheet.create({
  ...
  tabs: { flexDirection: 'row', flexWrap: 'wrap', paddingHorizontal: 24, gap: 8, marginBottom: 16 },
  ...
  itemCard: { flex: 1, backgroundColor: '#fff', borderRadius: 14, padding: 14, gap: 8, borderWidth: 1, borderColor: '#F0F0F0', minWidth: 0 },
