            ...
            return (
              <View style={styles.card}>
                ...
                <View style={styles.stepLabels}>
                  {STEPS.map((name, i) => (
                    <Text key={i} style={[styles.stepLabel, i + 1 === step && styles.stepLabelActive]}>{name}</Text>
                  ))}
                </View>
...
const styles = StyleSheet.create({
  ...
  stepLabel: { fontSize: 11, color: '#aaa', flex: 1, textAlign: 'center' },
